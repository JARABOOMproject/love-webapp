...
ขอบคุณที่เข้ามาในทุก ๆ วันของเรานะ และช่วยอยู่ด้วยกันตลอดไปนะคุณลลิตา(เก๋)`,
  ...
  // ── 4.6 แกลเลอรีหัวใจ — ซีเควนซ์สั้น (intro → ทักทาย → กระจาย → ลูกโลก → กำแพง → จดหมาย) ──
  // ข้อความทุกซีนแก้ที่นี่ที่เดียว (ห้าม hardcode ใน component)
  galleryStory: {
    holdHint: 'กดค้างเพื่อเริ่ม',
    greetings: ['สวัสดีคนเก่ง', 'อันนี้ตั้งใจทำให้เธอมากนะ', 'อยากเห็นมั้ยไปดูกัน'],
    letterTitle: 'ถึงคนเก่งของธนนันท์ 🧸',
    letterText: `ถึง คุณลลิตา,

เราแค่อยากบอกว่า...เรารู้สึกดีมากจริง ๆ ที่มีเธออยู่ในชีวิต ขอบคุณที่ยังอยู่ข้างกันมาตลอด ขอบคุณสำหรับทุกช่วงเวลา ทุกความทรงจำ และทุกเรื่องที่เราได้ผ่านมาด้วยกัน

ทุกครั้งที่ได้คุย ได้เจอ หรือได้ใช้เวลาอยู่กับเธอ มันเป็นช่วงเวลาที่มีความหมายสำหรับเรามาก เราอยากให้ความรู้สึกดี ๆ แบบนี้อยู่กับเราไปนาน ๆ อยากให้เรายังคงมีรอยยิ้ม มีเรื่องให้เล่ากัน และคอยอยู่ข้างกันแบบนี้ตลอดไป

คิดถึงเธอมาก ๆ นะ ช่วยอยู่ด้วยกันไปตลอดเลยนะ!!! 🤍`,
    letterClosing: 'เป็นยังไงบ้างเห็นแล้วชอบมั้ย ทางนี้ตั้งใจทำมากๆนะ🎁',
  },
  ...
  gallery: [
    ...
    '/photos/42_selfie-studio-photobooth.jpg',
  ],
}
